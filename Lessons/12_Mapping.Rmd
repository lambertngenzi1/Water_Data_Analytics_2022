...
---
## We changed the ID with Eno river
## Lesson Objectives
...
catchment <- subset$CatchmentSP  # polygon
waterbody <- subset$NHDWaterbody  # Anything as a waterbdy withi the catchment 
...
gages <- get_nwis(AOI = catchment)  # to find nearby gage especially upstream of the river, can specify the area
class(gages)

# find gages only within watershed
gages <- st_intersection(gages, catchment) #take 2 datasets and find the intersection
