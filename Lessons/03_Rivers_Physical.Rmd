...
shape and distances, sediment type, discharge (veolocity), slope, sinuosity
## Session Set Up
...
## As gage height increases, Discharge increases as well
```
...
dataRetrieval Vignette: ##(check it out)
...
```{r}
EnoSummary <- whatNWISdata(siteNumbers = "02096500") ## can look what data are online 
