...
$T = (n+1)/m$  # $ sign in front is to indicate is a fromula 
...
ggplot(EnoRecurrence, aes(x = RecurrenceInterval, y = PeakDischarge)) +
  geom_point() +
  scale_x_log10() +
  geom_smooth(method = "lm", color ="black", se = FALSE) ## lm is linear model 
...
> Eno river not stationary rivers displaying and climate change is also affecting 
When wanting to predict or forescast need. 
...
> Most recent data ar better to use when protecting agasint flooding 
